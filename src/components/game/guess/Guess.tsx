...
export default function Guess({name='', distance='', direction =''}: GuessProps) {
    ...
    const isRightGuess = name == solution;
            ...
            <p className={styles.countryName}>{name}</p>
                {isRightGuess ?
                 <div className={styles.iconCorrect}><BsFillCheckCircleFill/></div> :
                  <div className={styles.iconWrong}><MdWrongLocation/></div> }
    ...
    /* DISTANCE AND DIRECTION - IMPROVE LATER
